...
import { webServices, brandServices } from '@/lib/data';
...
export default function ServicesPage() {
  ...
  const allServices = [
    ...webServices.map(s => ({ ...s, group: "CUSTOM WEB DEVELOPMENT" })),
    ...brandServices.map(s => ({ ...s, group: "LOGO & BRAND IDENTITY" }))
  ];
    ...
    <div className="relative w-full bg-[#0A0A0A] text-[#F5F0EB] py-12 md:py-28 min-h-screen selection:bg-[#C8B89A] selection:text-[#0A0A0A]">
      ...
      <section className="max-w-6xl mx-auto px-6 md:px-12 mb-16 md:mb-24">
        <div className="space-y-6 md:space-y-8 max-w-4xl">
          ...
          <h1 className="font-serif italic text-4xl sm:text-5xl md:text-7xl lg:text-8xl text-[#F5F0EB] tracking-tight leading-[1.05] font-light font-serif">
