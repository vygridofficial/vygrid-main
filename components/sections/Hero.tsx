...
export default function Hero({
  ...
  return (
    <section className="relative w-full h-auto sm:h-[calc(100vh-80px)] min-h-0 sm:min-h-[650px] bg-[#0A0A0A] overflow-hidden select-none px-6 md:px-12 pt-8 pb-12 sm:pt-8 sm:pb-16 flex flex-col justify-between border-b border-white/5">
      ...
      <div className="z-10 text-left max-w-4xl space-y-7 sm:space-y-8 mt-24 sm:mt-auto">
        ...
        {/* CTA text links */}
        <div className="pt-3.5 sm:pt-4 flex flex-col sm:flex-row items-start sm:items-center gap-5 sm:gap-6">
          <Link
            href={primaryBtnHref}
